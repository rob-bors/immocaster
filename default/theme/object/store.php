...
function immocaster_theme_object_store($aVars)
{
	...
	// Maps
	if(IMMOCASTER_BASIC_LICENCE==true)
	{
		$oImmocasterExtBasic = IMMOCASTER_EXT_BASIC::getInstance();
		$aMapParameter = array('zoom'=>14,'width'=>'100%');
		$sCode .= $oImmocasterExtBasic->googleMaps($aExpose['geo'],$aExpose['address']['city'],$aMapParameter);
	}
